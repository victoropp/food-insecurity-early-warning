"""
Stage 2 Ablation Model 5: XGBoost with Ratio + Zscore + Location Features - OPTIMIZED
======================================================================================
Train XGBoost using ratio (9) + zscore (9) + location (2) = 20 total features
...
This tests the basic combined features WITHOUT HMM or DMD enhancements.
...
OUTPUT_DIR = STAGE2_MODELS_DIR / "ablation" / "ratio_zscore_location_optimized"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("ABLATION MODEL 5 - OPTIMIZED: RATIO + ZSCORE + LOCATION (20 FEATURES)")
print("=" * 80)
print(f"\nModel: ablation_ratio_zscore_location_optimized")
...
# =============================================================================
# PREPARE FEATURES - RATIO + ZSCORE + LOCATION (NO HMM, NO DMD)
# =============================================================================

print()
print("-" * 80)
print("STEP 4: Preparing Features (ABLATION: Ratio + Zscore + Location)")
print("-" * 80)
...
# ABLATION 5: Ratio + Zscore + Location (NO HMM, NO DMD)
...
for fold in range(N_FOLDS):
    ...
    # Save model
    model_file = OUTPUT_DIR / f"ablation_ratio_zscore_location_fold_{fold}.pkl"
    ...
    fold_predictions['model'] = 'ablation_ratio_zscore_location_optimized'
...
predictions_file = OUTPUT_DIR / "ablation_ratio_zscore_location_optimized_predictions.csv"
predictions_df.to_csv(predictions_file, index=False)
print(f"[OK] Predictions: {predictions_file.name}")

# CV results
cv_file = OUTPUT_DIR / "ablation_ratio_zscore_location_optimized_cv_results.csv"
...
summary = {
    'model': 'ablation_ratio_zscore_location_optimized',
    'model_type': 'ABLATION - Ratio + Zscore + Location (NO HMM, NO DMD)',
    'description': 'Ablation Model 5: Ratio + Zscore + Location (NO HMM, NO DMD) with GridSearchCV optimization',
...
summary_file = OUTPUT_DIR / "ablation_ratio_zscore_location_optimized_summary.json"
...
print()
print("=" * 80)
print("ABLATION MODEL 5 - OPTIMIZED COMPLETE")
print("=" * 80)
print(f"\nFeatures: {len(feature_cols)} (Ratio + Zscore + Location)")
print(f"Excluded: HMM, DMD")
...
print(f"\nOUTPUT FILES:")
print(f"  - ablation_ratio_zscore_location_optimized_predictions.csv")
print(f"  - ablation_ratio_zscore_location_optimized_cv_results.csv")
print(f"  - country_metrics.csv")
print(f"  - feature_importance.csv")
print(f"  - ablation_ratio_zscore_location_optimized_summary.json")
