"""
Stage 2 Ablation Model 4: XGBoost with Zscore + Location Features ONLY - OPTIMIZED
==================================================================================
Train XGBoost using ONLY zscore features (9) + location encoding (2) = 11 total features
...
OUTPUT_DIR = STAGE2_MODELS_DIR / "ablation" / "zscore_location_optimized"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("ABLATION MODEL 4 - OPTIMIZED: ZSCORE + LOCATION (11 FEATURES)")
print("=" * 80)
print(f"\nModel: ablation_zscore_location_optimized")
...
# ABLATION 4: Zscore + Location ONLY (NO ratio, NO HMM, NO DMD)
feature_cols = zscore_cols + location_cols
...
for fold in range(N_FOLDS):
    ...
    fold_predictions['model'] = 'ablation_zscore_location_optimized'
...
predictions_file = OUTPUT_DIR / "ablation_zscore_location_optimized_predictions.csv"
predictions_df.to_csv(predictions_file, index=False)
print(f"[OK] Predictions: {predictions_file.name}")

# CV results
cv_file = OUTPUT_DIR / "ablation_zscore_location_optimized_cv_results.csv"
...
summary_file = OUTPUT_DIR / "ablation_zscore_location_optimized_summary.json"
...
print()
print("=" * 80)
print("ABLATION MODEL 4 - OPTIMIZED COMPLETE")
print("=" * 80)
...
print(f"\nOUTPUT FILES:")
print(f"  - ablation_zscore_location_optimized_predictions.csv")
print(f"  - ablation_zscore_location_optimized_cv_results.csv")
print(f"  - country_metrics.csv")
print(f"  - feature_importance.csv")
print(f"  - ablation_zscore_location_optimized_summary.json")
