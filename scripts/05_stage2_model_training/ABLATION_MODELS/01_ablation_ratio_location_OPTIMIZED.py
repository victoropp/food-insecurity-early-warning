"""
Stage 2 Ablation Model 1: XGBoost with Ratio + Location Features ONLY - OPTIMIZED
==================================================================================
Train XGBoost using ONLY ratio features (9) + location encoding (3) = 12 total features
...
This isolates the baseline predictive power before adding z-scores, HMM, or DMD.
...
OUTPUT_DIR = STAGE2_MODELS_DIR / "ablation" / "ratio_location_optimized"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("ABLATION MODEL 1 - OPTIMIZED: RATIO + LOCATION (12 FEATURES)")
print("=" * 80)
print(f"\nModel: ablation_ratio_location_optimized")
...
# ABLATION 1: Ratio + Location ONLY (NO zscore, NO HMM, NO DMD)
feature_cols = ratio_cols + location_cols
...
for fold in range(N_FOLDS):
    ...
    # Save model
    model_file = OUTPUT_DIR / f"ablation_ratio_location_fold_{fold}.pkl"
    ...
    fold_predictions['model'] = 'ablation_ratio_location_optimized'
...
predictions_file = OUTPUT_DIR / "ablation_ratio_location_optimized_predictions.csv"
predictions_df.to_csv(predictions_file, index=False)
print(f"[OK] Predictions: {predictions_file.name}")

# CV results
cv_file = OUTPUT_DIR / "ablation_ratio_location_optimized_cv_results.csv"
...
summary = {
    ...
    'description': 'Ablation Model 1: Ratio + Location ONLY with GridSearchCV optimization',
...
summary_file = OUTPUT_DIR / "ablation_ratio_location_optimized_summary.json"
...
print(f"\nOUTPUT FILES:")
print(f"  - ablation_ratio_location_optimized_predictions.csv")
print(f"  - ablation_ratio_location_optimized_cv_results.csv")
print(f"  - country_metrics.csv")
print(f"  - feature_importance.csv")
print(f"  - ablation_ratio_location_optimized_summary.json")
