...
ARTICLES_FILE = BASE_DIR / 'data' / 'african_gkg_articles.csv'  # LARGE FILE (47GB) - see DATA/gdelt/LARGE_FILE_LOCATION.txt  # LARGE FILE (47GB) - see DATA/gdelt/LARGE_FILE_LOCATION.txt  # LARGE FILE (47GB) - see DATA/gdelt/LARGE_FILE_LOCATION.txt
